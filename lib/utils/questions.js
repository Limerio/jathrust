...
exports.questionsDatabase = exports.questionsGithub = exports.confirmStart = exports.confirmDelete = exports.projectType = exports.questions = void 0;
...
const projectType = [
    {
        ...
        validate: (value) => value.length === 0 ? `You don't have choice a type of project` : true,
    },
    {
    ...
    {
        type: (prev) => prev === constants_1.typeProject.apiExpress ? "confirm" : null,
        name: "graphqlIncludeConfirm",
        message: "Would you include graphql in your project ?",
        validate: (value) => value.length === 0 ? `You don't have choice if would you graphql` : true,
    },
    {
        type: "select",
        name: "lang",
...
const questionsDatabase = [
    ...
    },
    {
        ...
        choices: constants_1.choicesDB,
    },
];
exports.questionsDatabase = questionsDatabase;
