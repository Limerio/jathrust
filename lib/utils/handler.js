...
const startProject_1 = __importDefault(require("../projects/startProject"));
function handler(option, nameProject) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        else if (option === constants_1.newType.start) {
            const { confirm, event } = yield prompts_1.default(questions_1.confirmStart);
            yield startProject_1.default(confirm, nameProject, event);
        }
    });
}
