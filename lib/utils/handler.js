...
function handler(option, nameProject) {
    return __awaiter(this, void 0, void 0, function* () {
        if (option === constants_1.newType.new) {
            const { typeOfProject, lang, template, graphqlIncludeConfirm, } = yield prompts_1.default(questions_1.projectType);
            if (typeOfProject === constants_1.typeProject.basicExpress) {
                yield createProject_1.default(nameProject, constants_1.typeProject.basicExpress, lang, template, graphqlIncludeConfirm);
            }
            else if (typeOfProject === constants_1.typeProject.apiExpress) {
                yield createProject_1.default(nameProject, constants_1.typeProject.apiExpress, lang, template, graphqlIncludeConfirm);
            }
        }
