...
const installDB_1 = __importDefault(require("../init/installDB"));
// import prompts from "prompts";
// import { questionsGithub } from "../utils/questions";
const dir = process.cwd();
function createProject(nameProject, type, lang, template, graphqlIncludeConfirm) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield installDB_1.default(projectDir);
            yield initNpm_1.createTemplate(projectDir, type, lang, template, graphqlIncludeConfirm);
