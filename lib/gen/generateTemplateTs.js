...
function generateTypescriptTemplatePug(dir) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            fs_1.createDir(path_1.default.join(dir, "src", "views"));
            fs_1.createDir(path_1.default.join(dir, "src", "views", "includes"));
            fs_1.createDir(path_1.default.join(dir, "src", "views", "public"));
            fs_1.createDir(path_1.default.join(dir, "src", "views", "public", "js"));
            fs_1.createDir(path_1.default.join(dir, "src", "views", "public", "css"));
            fs_1.createDir(path_1.default.join(dir, "src", "views", "public", "img"));
            fs_1.createDir(path_1.default.join(dir, "build"));
            ...
            yield fs_1.writeFile(path_1.default.join(dir, "src", "views", "public", "js", "script.js"), "");
            yield fs_1.writeFile(path_1.default.join(dir, "src", "views", "public", "css", "styles.css"), templates_1.templateStyleCss);
        }
        catch (e) {
            return console.error(e);
        }
